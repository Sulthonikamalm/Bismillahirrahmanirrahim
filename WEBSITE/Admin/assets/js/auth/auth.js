...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if(loginForm) {
        loginForm.addEventListener('submit', async function(e) {
            ...
            try {
                const apiEndpoint = '/Bismillahirrahmanirrahim/WEBSITE/api/auth/login.php';
                ...
                if (data.status === 'success') {
                    ...
                    setTimeout(() => {
                        const redirectUrl = data.redirect || '/Bismillahirrahmanirrahim/WEBSITE/Admin/pages/cases/cases.html';
