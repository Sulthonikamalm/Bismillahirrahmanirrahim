...
async function checkAuthSession() {
    try {
        ...
        if (data.status !== 'authenticated') {
            ...
            window.location.href = '/Bismillahirrahmanirrahim/Admin/pages/auth/login.html?session=expired';
            return;
        }
        ...
        window.location.href = '/Bismillahirrahmanirrahim/Admin/pages/auth/login.html?error=auth_check_failed';
    }
}
...
async function handleLogout() {
    ...
    try {
        ...
        if (response.ok && data.status === 'success') {
            ...
            setTimeout(() => {
                window.location.href = data.redirect || '/Bismillahirrahmanirrahim/Admin/pages/auth/login.html';
            }, 500);
